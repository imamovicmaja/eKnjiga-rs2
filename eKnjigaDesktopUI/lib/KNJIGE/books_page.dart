...
class _BooksPageState extends State<BooksPage> {
  ...
  String formatAuthorDate(dynamic value) {
    if (value == null) return "";
    if (value is DateTime) return formatShortDate(value);
  ...
  void _onReviewFieldChanged() {
    ...
    _debounce = Timer(const Duration(milliseconds: _debounceMs), () {
      ...
      if (allEmpty) {
        ...
        loadReviewsFromApi(bookId: bookId, userId: userId, rating: rating);
      }
    });
  }

  Future<void> openBookPdf(int bookId) async {
    final pdfBytes = await ApiService.getBookPdf(bookId);

    final dir = await getTemporaryDirectory();
    final file = File('${dir.path}/knjiga_$bookId.pdf');
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                ] else if (selectedSidebar == "AUTORI") ...[
                                  Expanded(
                                    child: Wrap(
                                      spacing: 12,
                                      runSpacing: 12,
                                ...
                                ] else if (selectedSidebar == "KATEGORIJA") ...[
                                  SizedBox(
                                    width: 300,
                                    child: TextField(
                                ...
                                ] else if (selectedSidebar == "RECENZIJA") ...[
                                  Expanded(
                                    child: Wrap(
                                      spacing: 12,
                                      runSpacing: 12,
                                      ...
                                      children: [
                                        ...
                                        TextButton.icon(
                                          onPressed: () {
                                            setState(() {
                                              _selectedReviewBookId = null;
                                              _selectedReviewUserId = null;
                                            });
